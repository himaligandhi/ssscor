...
<img height="1" width="1" style="display:none;" alt="" src="https://px.ads.linkedin.com/collect/?pid=1996148&fmt=gif" />
    ...
    <title>Business Loan Guide</title>
    ...
    <?php include('header.php'); ?>
        ...
        <div class="container" style="padding:0;">
          ...
          <div class="centered">
                ...
                <h1 style="text-align: center; color:white;letter-spacing:1px; font-size:3.5em; font-weight:bold;"><u>BUSINESS LOAN GUIDE</u></h1>
          </div>
            ...
            <div class="a">
            <h1 style="text-align: center; color:#8E0414; margin-top:150px;"> Coming Soon</h1>
